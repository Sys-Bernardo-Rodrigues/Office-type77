/**
 * Importers/Callers: src/app/page.tsx / useOfficeStore (Task 8 HUD assembly)
...
export default function TycoonCatalogModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60" role="dialog" aria-modal="true">
      <div className="w-80 rounded-lg border-2 border-slate-700 bg-slate-900 p-4 text-white shadow-2xl">
